...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-brand-blue-depth text-white pt-32 pb-12 relative overflow-hidden">
      {/* Skewed Top Edge */}
      <div
        className="absolute top-0 left-0 w-full h-32 bg-surface-bg -translate-y-1/2 -skew-y-3 origin-top-left"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-24">
          ...
          <div className="flex-1 flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="flex-1 relative min-h-75 flex flex-col justify-start">
              ...
              <div className="relative w-72 h-72">
                <img src="./public/Footer.png" alt="Oportuniza Illustration" className="w-full h-full drop-shadow-2xl opacity-90" />
              </div>
            </div>

            {/* Links Columns Container */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:min-w-112.5">
              {/* Links Column */}
              <div>
